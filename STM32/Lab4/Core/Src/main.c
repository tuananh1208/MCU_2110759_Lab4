...
int main(void)
{
  ...
  SCH_Init();
  SCH_Add_Task(toggle1, 2, 500);
  SCH_Add_Task(toggle2, 3, 1000);
  SCH_Add_Task(toggle3, 5, 1500);
  SCH_Add_Task(toggle4, 7, 2000);
  SCH_Add_Task(toggle5, 11, 2500);
  SCH_Add_Task(oneShot, 5000, 0);
